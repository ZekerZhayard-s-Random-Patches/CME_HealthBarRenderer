                ...
                for (AbstractInsnNode ain : mn.instructions.toArray()) {
                    if (ain.getOpcode() == Opcodes.INVOKEVIRTUAL) {
                        ...
                        if (min.owner.equals("net/md_5/specialsource/provider/JointProvider") && min.name.equals("add") && min.desc.equals("(Lnet/md_5/specialsource/provider/InheritanceProvider;)V")) {
                            ...
                            mn.instructions.insertBefore(min, new MethodInsnNode(Opcodes.INVOKESTATIC, "io/github/zekerzhayard/cme_healthbarrenderer/gradle/unsafe/modifiers/hooks/ProcessJarTaskHook", "addProvider", "(Lnet/md_5/specialsource/provider/InheritanceProvider;Lnet/md_5/specialsource/provider/JointProvider;)Lnet/md_5/specialsource/provider/InheritanceProvider;", false));
                        }
                    }
                }
            }
