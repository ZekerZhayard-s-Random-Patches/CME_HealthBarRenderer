                ...
                for (AbstractInsnNode ain : mn.instructions.toArray()) {
                    if (ain.getOpcode() == Opcodes.INVOKEVIRTUAL) {
                        ...
                        if (min.owner.equals("java/io/File") && min.name.equals("exists") && min.desc.equals("()Z")) {
                            mn.instructions.insertBefore(ain, new MethodInsnNode(Opcodes.INVOKESTATIC, "io/github/zekerzhayard/cme_healthbarrenderer/gradle/unsafe/modifiers/hooks/UserBasePluginHook", "createWorkspaceXml", "(Ljava/io/File;)Ljava/io/File;", false));
                        }
                    }
                }
            }
