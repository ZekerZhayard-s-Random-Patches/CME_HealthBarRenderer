            ...
            if (mn.name.equals("makeObtainTasks") && mn.desc.equals("()V")) {
                ...
                for (AbstractInsnNode ain : mn.instructions.toArray()) {
                    if (ain.getOpcode() == Opcodes.ARETURN) {
                        ...
                        mn.instructions.insertBefore(ain, new MethodInsnNode(Opcodes.INVOKESTATIC, "io/github/zekerzhayard/cme_healthbarrenderer/gradle/unsafe/modifiers/hooks/BasePluginHook", "resolve", "(Ljava/lang/String;Lnet/minecraftforge/gradle/common/BasePlugin;)Ljava/lang/String;", false));
                    }
                }
            }
        }
